...
<head>
    ...
    <title>[SISCO] - Senarai Pelajar Kor</title>
...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									<!-- Student -->
                                    <a class="active" href="senarai_pelajar.php"> <i class="fa fa-server fa-fw"></i> Pelajar Kor</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
			<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Senarai Pelajar Kor</h1>
                </div>
                <!-- /.col-lg-12 -->
			<?php							
				// List by batch development
				// create the selection query
				$sql1 = "SELECT * FROM COURSE ORDER BY CR_ID";
				
				// execute selection query
				$result1 = mysql_query($sql1) or die("SQL select statement failed");

				echo '<center><table align="center"><tr><form id="papar" action="" method="get"><font size="3"><td align="right"><b><i>&nbsp;Pilih kursus kor :&nbsp;&nbsp;</i></b><select name="pilih"></font><option value=""> Semua </option>';
				$BATCH_TEMP = 0;
				while ($row = mysql_fetch_array($result1))
				{
					...
					echo '<option value="' . $CR_ID . '"> ' . $CR_NAME . ' </option>';
				}
				echo '</select>&nbsp;<button type="submit" form="papar" value="Submit">Papar</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></form>';
				echo '<form id="cari" action="" method="get"><center><font size="3"><td align="right"><b><i>&nbsp;Cari pelajar kor :&nbsp;&nbsp;</i></b><input type="text" name="cari_id" maxlength="10" size="7" autofocus>&nbsp;<button type="submit" form="cari" value="Submit">Cari</button>&nbsp;</td></form></tr></table></center><br>';
				...
				if (isset($_GET['cari_id']))
				{
					...
					$sql = "SELECT S_ID, S_NAME, S_CRS, S_PLTN FROM STUDENT WHERE S_ID LIKE '%$CARI_ID%' UNION SELECT S_ID, S_NAME, S_CRS, S_PART FROM STUDENT WHERE S_NAME LIKE '%$CARI_ID%' UNION SELECT S_ID, S_NAME, S_CRS, S_PART FROM STUDENT WHERE S_IC LIKE '%$CARI_ID%' ORDER BY S_CRS, S_PLTN, S_NAME";
				...
				if (isset($_GET['pilih']))
				{
					...
					{
						$TBATCH	= "WHERE S_CRS = '" . $_GET['pilih'] . "'";
					}
					// create the listing query
					$sql = "SELECT S_ID, S_NAME, S_CRS, S_PLTN FROM STUDENT $TBATCH ORDER BY S_CRS, S_PLTN, S_NAME";
					
					// execute listing query
					$result = mysql_query($sql) or die("SQL select statement failed");
				}
				// Papar table
				if (isset($_GET['cari_id']) || isset($_GET['pilih']))
				{
			?>
			<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center><b>Senarai Pelajar Kokurikulum</b></center>
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
										<?php
											while ($row = mysql_fetch_array($result))
											{
												...
												<tr>
													<td><?php print($BIL); ?></td>
													<td><a target='_blank' href='rincian_pelajar.php?ID=<?php print($S_ID); ?>'><?php print($S_NAME); ?></a></td>
													<td><?php print($DCRS); ?></td>
											...
											if($BIL == 0)
											{
												echo "<tr><td align='center' colspan='4'><i> Tiada data untuk dipaparkan </i></td></tr>";
											}
										?>
                                    </tbody>
                                </table>
