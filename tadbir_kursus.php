...
<head>
	<?php
		...
		{	
			...
			//SQL query command
			$sql="INSERT INTO COURSE (CR_ID, CR_NAME) VALUES ('$ID_PROG', '$PROG')";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Kursus</h1>
						<!-- mula     ##########################################################################################     mula -->
						<form id="tambah_course" action ="tadbir_kursus.php" method ="POST">
							<input type="hidden" name="DAFTAR" value="YES">
							<table style="BORDER-COLLAPSE: collapse" 
									  bordercolor="#cccccc" align="center" cellspacing="0" 
									  cellpadding="0" border="1">
							<td><table align="center">
								<tr><td align="center"><b>ID Kursus</b></td><td><input type="text" maxlength="6" size="3" name="ID_PROG">&nbsp;&nbsp;&nbsp;</td>
									<td align="center"><b>Kursus</b></td><td><input type="text" size="30" maxlength="100" name="PROG">&nbsp;&nbsp;&nbsp;</td>
									<td align="center"><button type="submit" form="tambah_course" value="Submit">Tambah</button></td></tr>
							</table></td></table>
						</form>
						<?php
							...
							echo '<tbody>
									<tr>';
							echo '<tr><td colspan="5" align="center" height="24" background="../JCIS/images/1_background_table.gif"><div align="center"><b>Senarai Kursus</b></div></td></tr>';
							...
							echo '<tbody>
									...
									<td align="center"><b>Kursus</b></td><tr>';
							...
							while ($row = mysql_fetch_array($result))
							{
								...
								echo "<tr>";
								echo '<td align=center>' . $ID_PROG . '</td><td align=left>' . $PROG . '</td><td align=center>' . $KAMPUS . '</td><td align=center><input type="button" value="Padam Kursus" onClick=confirmDel("' . $ID_PROG . '") ></td>';
								echo "</tr>"; 
							}
							if($BIL == 0)
							{
								echo "<tr><td align='center' colspan='5'><i> Tiada kursus untuk dipaparkan </i></td></tr>";
							}
